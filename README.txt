...
default format (editable): YYYY-MM-DD-XXBPM-KEYWORD
		       ex: 2022-02-18-98BPM-rhodes loop


DESCRIPTION:

a (super) simple python script that generates a filename in YYYY-MM-DD-XXBPM-KEYWORD format that is sent to your clipboard.

as you can see there are a few weird work arounds required to get this running but this incredibly simple script has saved me so much time, I would definitely recommend trying it.
